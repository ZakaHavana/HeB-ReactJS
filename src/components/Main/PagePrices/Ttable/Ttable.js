...
class Table extends Component {
  state = {
    details: [
      {
        title: "FULL PASS until July 31st",
        firstPrice: "110 e",
        secondPrice: "Workshops (2 days)",
        thirdPrice: "Parties (4 days)",
        concerts: "concerts",
      },
      {
        title: "FULL PASS until September 30st",
        firstPrice: "120 e",
        secondPrice: "Workshops (2 days)",
        thirdPrice: "Parties (4 days)",
        concerts: "concerts",
      ...
      {
        title: "FULL PASS until October 31st",
        firstPrice: "130 e",
        secondPrice: "Workshops (2 days)",
        thirdPrice: "Parties (4 days)",
        concerts: "concerts",
          ...
          return (
            <table key={el.title} className={classes.Table}>
              <tbody>
                ...
                <tr>
                  <td className={classes.Drugi}>{el.firstPrice}</td>
                </tr>
                <tr>
                  <td>{el.secondPrice}</td>
                </tr>
                <tr>
                  <td className={classes.Drugi}>{el.thirdPrice}</td>
                </tr>
                <tr>
                  <td>{el.concerts}</td>
                </tr>
